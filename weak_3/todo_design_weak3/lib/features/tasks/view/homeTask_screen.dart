...
class HomeTasksScreen extends StatefulWidget {
  ...
  @override
  State<HomeTasksScreen> createState() => _PersonalTasksScreenState();
}

class _PersonalTasksScreenState extends State<HomeTasksScreen> {
  @override
  void initState() {
    super.initState();
    context.read<TaskCubit>().startHomeTasksStream();
  }
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    SvgPicture.asset(Appicons.home, width: 16, height: 16),
                    SizedBox(width: 4),
                    Text(
                      'Home',
                      style: TextStyle(
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          SvgPicture.asset(Appicons.home, width: 80, height: 80),
          SizedBox(height: 24),
          Text(
            'No Home Tasks',
            style: TextStyle(
          ...
          SizedBox(height: 8),
          Text(
            'Add your first Home task to get started!',
