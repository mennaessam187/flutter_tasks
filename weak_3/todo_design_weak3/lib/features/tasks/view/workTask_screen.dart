...
class WorkTasksScreen extends StatefulWidget {
  ...
  @override
  State<WorkTasksScreen> createState() => _PersonalTasksScreenState();
}

class _PersonalTasksScreenState extends State<WorkTasksScreen> {
  @override
  void initState() {
    super.initState();
    context.read<TaskCubit>().startWorkTasksStream();
  }
              ...
              children: [
                BlocBuilder<TaskCubit, TaskState>(
                  builder: (context, state) {
                    return state is Getworktasks
                        ? Smallcontainer(
                            fontsize: 15,
                            width: 23.w,
                            height: 23.h,
                            color: AppColor.workBackgroundcolor,
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    SvgPicture.asset(Appicons.work, width: 16, height: 16),
                    SizedBox(width: 4),
                    Text(
                      'Work',
                      style: TextStyle(
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          SvgPicture.asset(Appicons.work, width: 80, height: 80),
          SizedBox(height: 24),
          Text(
            'No Work Tasks',
            style: TextStyle(
